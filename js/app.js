...
app.service("GroceryService", function($http){
    ...
    $http.get("data/server_data.json").then(function success(response){
    ...
    groceryService.removeItem = function(entry){
        ...
        $http.post("data/delete_item.json",{id:entry.id}).then(function success(response){

           if(response.data.status == 1) {
               var index = groceryService.groceryItems.indexOf(response.data);
    ...
    groceryService.save = function(entry) {
        ...
        if(updatedItem){
            ...
            $http.post("data/updated_item.json", entry).then(function success(response){
                if(response.data.status == 1){
            ...
            $http.post("data/added_item.json", entry).then(function success(response){
...
app.directive("jcGroceryItem", function(){
    return{
        restrict: "E",
